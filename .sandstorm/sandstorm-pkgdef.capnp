...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "9afdqyf3v446h1xd5d9xggkndrs627ha0wr0aw2nkcf1rthm4qn0",
  ...
  manifest = (
    ...
    metadata = (
      ...
      icons = (
        ...
        appGrid = (png = (dpi1x = embed "asset/note-128x128.png")),
        grain = (png = (dpi1x = embed "asset/note-24x24.png",
                        dpi2x = embed "asset/note-48x48.png")),
        market = (png = (dpi1x = embed "asset/note-150x150.png")),
        marketBig = (png = (dpi1x = embed "asset/note-300x300.png")),
      ),

      website = "https://github.com/PDIS/sandmd",
      # This should be the app's main website url.

      codeUrl = "https://github.com/PDIS/sandmd",
      ...
      author = (
        ...
        pgpSignature = embed "asset/pgp-signature",
      ...
      pgpKeyring = embed "asset/pgp-keyring",
      ...
      description = (defaultText = embed "asset/description.md"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "4444", "--", "/bin/bash", "/opt/app/.sandstorm/launcher.sh"],
  environ = [
